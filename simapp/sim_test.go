...
import (
	...
	"github.com/osiz-blockchainapp/euro-sdk/baseapp"
	sdk "github.com/osiz-blockchainapp/euro-sdk/types"
	"github.com/osiz-blockchainapp/euro-sdk/x/auth"
	authsim "github.com/osiz-blockchainapp/euro-sdk/x/auth/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/bank"
	distr "github.com/osiz-blockchainapp/euro-sdk/x/distribution"
	distrsim "github.com/osiz-blockchainapp/euro-sdk/x/distribution/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/gov"
	govsim "github.com/osiz-blockchainapp/euro-sdk/x/gov/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/mint"
	"github.com/osiz-blockchainapp/euro-sdk/x/params"
	paramsim "github.com/osiz-blockchainapp/euro-sdk/x/params/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/slashing"
	slashingsim "github.com/osiz-blockchainapp/euro-sdk/x/slashing/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/staking"
	stakingsim "github.com/osiz-blockchainapp/euro-sdk/x/staking/simulation"
	"github.com/osiz-blockchainapp/euro-sdk/x/supply"
)
...
func invariants(app *SimApp) []sdk.Invariant {
	...
	// Ref: https://github.com/osiz-blockchainapp/euro-sdk/issues/4631
	if period == 1 {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/osiz-blockchainapp/euro-sdk/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
