...
import (
	...
	stakingtypes "github.com/osiz-blockchainapp/euro-sdk/x/staking/types"
)
...
func TestNetGenesisState(t *testing.T) {
	...
	assert.NotNil(t, gen.GenTxs) // https://github.com/osiz-blockchainapp/euro-sdk/issues/5086
