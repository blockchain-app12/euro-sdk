...
import (
	...
	"github.com/osiz-blockchainapp/euro-sdk/x/staking/exported"
)
...
func (k Keeper) AllocateTokens(
	...
	// general discussions here: https://github.com/osiz-blockchainapp/euro-sdk/issues/2906#issuecomment-441867634
	...
	// TODO consider parallelizing later, ref https://github.com/osiz-blockchainapp/euro-sdk/pull/3099#discussion_r246276376
	for _, vote := range previousVotes {
		validator := k.stakingKeeper.ValidatorByConsAddr(ctx, vote.Validator.Address)

		// TODO consider microslashing for missing votes.
		// ref https://github.com/osiz-blockchainapp/euro-sdk/issues/2525#issuecomment-430838701
