...
- [SDK API 参考](https://godoc.org/github.com/osiz-blockchainapp/euro-sdk): Cosmos SDK Godocs 文档 。
...
参考 [文档说明](https://github.com/osiz-blockchainapp/euro-sdk/blob/master/docs/DOCS_README.md) 了解构建细节及更新时注意事项。
