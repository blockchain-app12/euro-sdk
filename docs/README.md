...
- [SDK API Reference](https://godoc.org/github.com/osiz-blockchainapp/euro-sdk): Godocs of the Cosmos SDK.
...
See [this file](https://github.com/osiz-blockchainapp/euro-sdk/blob/master/docs/DOCS_README.md) for details of the build process and
