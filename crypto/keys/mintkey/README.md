...
```bash
go test -v --bench github.com/osiz-blockchainapp/euro-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/osiz-blockchainapp/euro-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/osiz-blockchainapp/euro-sdk/crypto/keys/mintkey	12.093s
```
