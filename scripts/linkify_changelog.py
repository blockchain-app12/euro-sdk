...
# " [\#number](https://github.com/osiz-blockchainapp/euro-sdk/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]+)", r" [\\#\1](https://github.com/osiz-blockchainapp/euro-sdk/issues/\1)", line.rstrip())
    print(line)